...
def configure_proxy() -> None:
    ...
    if scraper_api_key:
        ...
        # signature. Obtain one proxy through free-proxy's public API and
        # pass it back to scholarly as a single proxy instead.
        proxy_url = FreeProxy(
            rand=True,
            timeout=1,
            https=True,
    ...
    # Passing the generator twice prevents scholarly from silently creating
    # its own incompatible FreeProxies generator for secondary requests.
